...
int main()
{
    ...
    struct sockaddr_in srv;// sockaddr_in for IPV4
    srv.sin_family = AF_INET;
    sock_addr_serv.sin_port = htons(PORT); //MSB firsr order
    sock_addr_serv.sin_addr.s_addr = INADDR_ANY;	//only for server					//inet_addr("127.0.0.1");
